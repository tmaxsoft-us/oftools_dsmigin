#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Enumerate error and log messages, with associated colors.
"""
...
class Color(enum.Enum):
    """List colors used in this program.
    """
    GREEN = "\x1b[92m"
    RED = "\x1b[91m"
    WHITE = "\x1b[39m"
...
class ErrorM(enum.Enum):
    """List error messages used in this program.
    """
...
class LogM(enum.Enum):
    """List log messages used in this program.
    """
